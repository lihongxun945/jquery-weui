      ...
      var config = {
        ...
        onChange: function (picker, values, displayValues) {
          ...
          if(params.min) {
            ...
            if(current < +min) {
              if (!lastValidValues) {
                  var minDate = [min.getFullYear(), self.formatNumber(min.getMonth() + 1), self.formatNumber(min.getDate()), self.formatNumber(min.getHours()), self.formatNumber(min.getMinutes())];
          ...
          if(params.max) {
            ...
            if(current > +max) {
              if (!lastValidValues) {
                  var maxDate = [max.getFullYear(), self.formatNumber(max.getMonth() + 1), self.formatNumber(max.getDate()), self.formatNumber(max.getHours()), self.formatNumber(max.getMinutes())];
